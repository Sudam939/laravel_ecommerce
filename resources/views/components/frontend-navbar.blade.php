            ...
            <div class="flex-grow">
                <form action="" method="get">
                    <div class="flex">
                        ...
                        <button type="submit"
                            class="bg-gray-300 text-[#009900] font-bold px-4 rounded-e-lg">COMPARE</button>
                    </div>
                </form>
            </div>

            <div>
                <a href="" class="bg-[#2bbb2b] px-4 py-1 rounded-md text-white">SignUp</a>
                <a href="" class="bg-[#ffcc33] px-4 py-1 rounded-md">Login <i class="fa-solid fa-arrow-right"></i></a>
            </div>
        </div>
    </div>
</nav>
